...
12) PCA + AUTOENCODERS:
    ...
    This project represents the first steps towards Generative Adversarial Networks (GAN), which I'll be working on the following weeks. Before getting our hands-on developing GANs, we need to understand how PCA and Autoencoders work. 
